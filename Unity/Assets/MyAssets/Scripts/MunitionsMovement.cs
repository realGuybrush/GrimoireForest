...
public class MunitionsMovement : InventoryMovement
{
    private List<List<string>> presetTypes = new List<List<string>>() { new List<string>() { "Helmet" },
                                                                        new List<string>() { "Armor" },
                                                                        new List<string>() { "Pants" },
                                                                        new List<string>() { "Boots" },
                                                                        new List<string>() { "Gloves" },
                                                                        new List<string>() { "Shield" },
                                                                        new List<string>() { "Gun", "Sword", "Spear", "Arrow", "Rod", "MagicArtefact", "Bow" },
                                                                        new List<string>() { "Gun", "Sword", "Spear", "Arrow", "Rod", "MagicArtefact", "Bow" },
                                                                        new List<string>() { "Gun", "Sword", "Spear", "Arrow", "Rod", "MagicArtefact", "Bow" },
                                                                        new List<string>() { "Gun", "Sword", "Spear", "Arrow", "Rod", "MagicArtefact", "Bow" },
                                                                        new List<string>() { "Gun", "Sword", "Spear", "Arrow", "Rod", "MagicArtefact", "Bow" }};
    ...
    {
        if (presetTypes[index].Contains(WM.ItemPrefabs[item].GetComponent<Item>().itemValues.type))
        {
            return true;
        }
        return false;
